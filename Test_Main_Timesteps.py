...
while time<Time.nt:
    ...
    #NO load balance (this is to just test if the code runs the Reynoldssolver for a couple of time steps --> choose a large timestep ex. for 2400 rpm 0.01 (5 timesteps))
    #Predefined min film thickness h0
    # h0 = 10e-6
    ...
    #DO implement load balance: Quasi-Newton method
